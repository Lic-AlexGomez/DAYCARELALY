...
Revision ID: 7788574b35bb
Revises: 
Create Date: 2025-01-24 04:25:38.192749
...
def upgrade():
    ...
    sa.Column('birth_certificate_url', sa.String(length=200), nullable=True),
    sa.Column('immunization_records_url', sa.String(length=200), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
