...
const menuItems = [
  ...
  { icon: Activity, label: 'Programas', path: '/admin-dashboard/activities' },
  ...
  { icon: UserX, label: 'Servicios', path: '/admin-dashboard/services' },
  { icon: UserX, label: 'Galeria', path: '/admin-dashboard/gallery' },
