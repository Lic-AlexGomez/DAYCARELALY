    ...
    <div className="tw-flex tw-h-screen tw-overflow-hidden">
      <div className="tw-flex-1 tw-overflow-auto">
        <header className="tw-flex tw-items-center tw-justify-between tw-p-4 tw-border-b">
          <h1 className="tw-text-2xl tw-font-bold">Contact Us Messages Management</h1>
        </header>
          ...
          <div className="tw-bg-white tw-shadow-md tw-rounded-lg tw-p-6">
            ...
            <div className="tw-space-y-4">
              {currentContacts.map((contact) => (
                <div key={contact.id} className="tw-bg-white tw-rounded-lg tw-shadow-md tw-p-4">
                  <div className="tw-flex tw-flex-col md:tw-flex-row tw-justify-between tw-items-center tw-mb-2 tw-gap-4">
                    <div className="tw-text-center md:tw-text-left">
                      ...
                      <p className="tw-text-sm tw-text-gray-500">{`${contact.first_name} ${contact.last_name}`}</p>
                    </div>
                    <div className="tw-text-center md:tw-text-left">
                      <span className="tw-font-bold">Email</span>
                      <p className="tw-text-sm tw-text-gray-500">{contact.email}</p>
                    </div>
                    <div className="tw-text-center md:tw-text-left">
                      <span className="tw-font-bold">Subject</span>
                      <p className="tw-text-sm tw-text-gray-500">{contact.subject}</p>
                    </div>
                    <div className="tw-text-center md:tw-text-left">
                      <span className="tw-font-bold">Phone</span>
                      <p className="tw-text-sm tw-text-gray-500">{contact.phone_number}</p>
                    </div>
                  </div>
        ...
        >
          <div className="tw-relative tw-top-20 tw-mx-auto tw-p-5 tw-border tw-w-full md:tw-w-96 tw-shadow-lg tw-rounded-md tw-bg-white">
            <div className="tw-mt-3 tw-text-center">
              <h3 className="tw-text-lg tw-leading-6 tw-font-medium tw-text-gray-900">{selectedContact.subject}</h3>
              <div className="tw-mt-2 tw-px-7 tw-py-3">
                <p className="tw-text-sm tw-text-gray-500">
                  <strong>From:</strong> {selectedContact.first_name} {selectedContact.last_name} (
                  {selectedContact.email})
                </p>
                <p className="tw-text-sm tw-text-gray-500">
                  <strong>Phone:</strong> {selectedContact.phone_number}
                </p>
                <p className="tw-text-sm tw-text-gray-700 tw-mt-4">{selectedContact.message}</p>
              </div>
