...
const CardHeader = ({ className, children, ...props }) => (
  <div className={`tw-px-6 tw-py-4 tw-border-b-4 tw-border-[#FFC909] tw-bg-[#9C29B2] tw-bg-opacity-10 tw-rounded-t-3xl ${className}`} {...props}>
    {children}
  </div>
);

const CardTitle = ({ className, children, ...props }) => (
  <h2 className={`tw-text-3xl tw-font-bold tw-text-center tw-text-[#9C29B2] tw-font-comic-sans ${className}`} {...props}>
    {children}
  </h2>
);
            ...
            <Tabs className="tw-w-full">
              <TabsList className="tw-grid tw-w-full tw-grid-cols-3">
                ...
                <TabsTrigger
                  ...
                  isActive={activeTab === 'role-specific'}
                >
                  Role Details
                </TabsTrigger>
              </TabsList>
                    ...
                    <div className="tw-space-y-2">
                      ...
                      <div className="tw-flex tw-items-center tw-space-x-2">
                        <Input
                          ...
                          className="tw-hidden"
                        />
                        <Label htmlFor="profilePicture" className="tw-cursor-pointer tw-flex tw-items-center tw-justify-center tw-w-full tw-h-32 tw-border-2 tw-border-dashed tw-border-[#9C29B2] tw-rounded-lg tw-bg-[#FFC909] tw-bg-opacity-10 hover:tw-bg-opacity-20 tw-transition-colors">
