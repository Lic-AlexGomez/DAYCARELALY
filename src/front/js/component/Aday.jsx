                ...
                <div className="timeline">
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3>8:00 AM - Welcome & Free Play</h3>
                            <p>Children arrive and engage in free play activities.</p>
                        </div>
                    </div>
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3>9:30 AM - Circle Time</h3>
                            <p>Group activities, songs, and interactive learning.</p>
                        </div>
                    </div>
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3>10:30 AM - Snack Time</h3>
                            <p>Healthy snacks are served to keep energy levels up.</p>
                        </div>
                    </div>
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3>11:00 AM - Outdoor Play</h3>
                            <p>Weather permitting, children enjoy outdoor activities.</p>
                        </div>
                    </div>
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3>12:00 PM - Lunch & Rest</h3>
